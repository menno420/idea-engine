...
> **Grounding:** https://github.com/menno420/idea-engine@16480db (session branch head, containing main 636e21d) · fetched 2026-07-16T02:23:41Z
> (the dedup-sweep HEAD, the only read this head takes; every model constant below is invented-but-pinned in this file, and the DECISION arms are exact seedless integer/Fraction arithmetic with zero repo/network reads at verdict time — the P017–P076 hermetic precedent; sim-lab dedup-swept READ-ONLY on the local clone @ 418de3e090ea89762a2135bcd63f4c229b2e8054, VERDICT 092 newest)
