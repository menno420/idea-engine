...
Reviewed the freshest merged cards: P130 annual-prepay financing trap (#561, e8c0193, round-30 VENTURE) and P129 correlated-vote Condorcet jury ceiling (#560, FLEET). Conventions carried forward: GROUNDING real permalink@SHA, probe-report bold numbers, recommendation line, dated-claim filename prefix, version-less Model line, whole-dict sha256 posture (P123/P127 family). No defects found.
